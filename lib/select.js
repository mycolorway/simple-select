...
Select = (function(superClass) {
  ...
  Select._tpl = {
    multiInput: "<textarea rows=1 type=\"text\" class=\"select-result\" autocomplete=\"off\"></textarea>",
    singleInput: "<input type=\"text\" class=\"select-result\" autocomplete=\"off\">",
  ...
  Select.prototype._render = function() {
    ...
    if (this.opts.multiInput) {
      this.select.addClass('multi');
