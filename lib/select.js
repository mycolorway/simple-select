...
Select = (function(_super) {
  ...
  Select.prototype._render = function() {
    var items;
    this.el = $(this.opts.el).data("select", this).hide();
    this.select = $(Select._tpl.select).addClass(this.opts.cls).insertAfter(this.el);
    this.input = $(Select._tpl.input).attr("placeholder", this.opts.placeholder).prependTo(this.select);
  ...
  Select.prototype.destroy = function() {
    this.select.remove();
    return this.el.removeData("select").show();
  };
