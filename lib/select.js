...
Select = (function(superClass) {
  ...
  Select._tpl = {
    input: "<div contenteditable=true class=\"select-result\"></div>",
  ...
  Select.prototype._init = function() {
    ...
    this._render();
    this._bind();
    return this.trigger("change", [this.input.html()]);
  };
  ...
  Select.prototype._render = function() {
    ...
    this.input = $(Select._tpl.input).attr("placeholder", this.opts.placeholder || this.el.data('placeholder') || "").addClass("placeholder").prependTo(this.select);
  ...
  Select.prototype._expand = function(expand) {
    if (expand === false) {
      ...
      this.list.css('top', this.input.outerHeight() + 5);
  ...
  Select.prototype._bind = function() {
    ...
    return this.on("change", (function(_this) {
      return function(e, content) {
        return _this._change(e, content);
      };
    })(this));
  };
  ...
  Select.prototype._keyup = function(e) {
    ...
    this.trigger("change", [this.input.html()]);
  ...
  Select.prototype._change = function(e, content) {
    this.input.val(content);
    if (content && this.input.hasClass('placeholder')) {
      this.input.removeClass('placeholder');
    }
    if (!content && !this.input.hasClass('placeholder')) {
      return this.input.addClass('placeholder');
    }
  };
  ...
  Select.prototype.selectItem = function(index) {
    ...
    if ($.isNumeric(index)) {
      ...
      this.input.html(item.label).removeClass("expanded error");
  ...
  Select.prototype.clearSelection = function() {
    this.input.html("").removeClass("expanded error");
